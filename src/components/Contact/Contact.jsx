  ...
  return (
    <section className="bg-white flex flex-col m-2 p-4 justify-center items-center"  id="contacts">
        ...
        <label htmlFor="email"></label>
            <input className="bg-slate-400 text-white placeholder-white" type="email" placeholder="Name" />
            <label htmlFor="email"></label>
            <input className="bg-slate-400 text-white placeholder-white" type="email" placeholder="Email" />
